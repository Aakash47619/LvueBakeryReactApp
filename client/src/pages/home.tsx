          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <Card className="bakery-product-card" data-aos="fade-up" data-aos-delay="200">
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2 text-navy font-serif">Artisan Croissants</h3>
            ...
            <Card className="bakery-product-card" data-aos="fade-up" data-aos-delay="300">
              ...
              />
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2 text-navy font-serif">Custom Celebration Cakes</h3>
                <p className="text-gray-600">
            ...
            <Card className="bakery-product-card" data-aos="fade-up" data-aos-delay="400">
              ...
              />
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2 text-navy font-serif">Gourmet Pastries</h3>
                <p className="text-gray-600">
            ...
            <Card className="bakery-product-card" data-aos="fade-up" data-aos-delay="500">
              ...
              />
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2 text-navy font-serif">Artisan Breads</h3>
                <p className="text-gray-600">
            ...
            <Card className="bakery-product-card" data-aos="fade-up" data-aos-delay="600">
              ...
              />
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2 text-navy font-serif">Seasonal Specialties</h3>
                <p className="text-gray-600">
            ...
            <Card className="bakery-product-card" data-aos="fade-up" data-aos-delay="700">
              ...
              />
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2 text-navy font-serif">Coffee & Beverages</h3>
                <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
            <div className="space-y-8" data-aos="fade-right" data-aos-delay="200">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-navy font-serif">Location & Hours</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-navy font-serif">Opening Hours</h3>
                <div className="space-y-2 text-gray-600">
                  <p className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-navy font-serif">Connect With Us</h3>
                <div className="space-y-2 text-gray-600">
                  <p className="flex items-center gap-3">
